...
public:
   ...
   bool collider(GLfloat J[4][2], GLfloat size);

   void	drawAreneComplexe(GLfloat size, GLenum type);

   void	drawArene(GLfloat size, GLenum type);

   void	drawPlayer(GLfloat size, GLenum type, bool player);
